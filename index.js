...
const URL_WINDOW = [
  'https://onlyfans.com/',
  'https://www.coinbase.com/pl/explore',
  'https://goreplace.org/about/videos/P12',
  'https://www.wp.pl/',
  'https://kekma.net/',
  'https://www.youtube.com/shorts/6JWWB-Ycma8',
  'https://www.youtube.com/shorts/z2kRBY52zXE'
]
...
const PHRASES = [
  '👽🌌 Exploring the unknown universe, seeking 👽🚀 extraterrestrial life. 👽🌠',
  '🌍🛸 Are we alone in the universe? 👽🌌 Curiosity about alien existence grows. 👽🔭',
  '👽👾🌌 Speculating on different forms of extraterrestrial beings. 👽🌠🌟',
  '👽🌠🚀 Imagining encounters with aliens, a cosmic fascination. 🌌👾🛸'
]
...
function superLogout () {
  ...
  for (const name in LOGOUT_SITES) {
    ...
    div.innerText = '👽🛸🌌 Aliens 👽👾👽 are around 🌍 us! ${name}... 🚀👀'
